...
// Clausulas de exibição para avaliador
$video_order_clause_sql = "ORDER BY v.created_at ASC"; // Fallback
// $video_eval_order foi definido em config.php
switch ($video_eval_order) { // $video_eval_order vem de config.php
    case 'RAND':
        $video_order_clause_sql = "ORDER BY RAND()";
        break;
    case 'ID_ASC':
        $video_order_clause_sql = "ORDER BY v.id ASC";
        break;
    case 'ID_DESC':
        $video_order_clause_sql = "ORDER BY v.id DESC";
        break;
    case 'TITLE_ASC':
        $video_order_clause_sql = "ORDER BY v.titulo ASC";
        break;
    case 'TITLE_DESC':
        $video_order_clause_sql = "ORDER BY v.titulo DESC";
        break;
    case 'CREATED_AT_ASC':
        $video_order_clause_sql = "ORDER BY v.created_at ASC";
        break;
    case 'CREATED_AT_DESC':
        $video_order_clause_sql = "ORDER BY v.created_at DESC";
        break;
}
